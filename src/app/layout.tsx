...
export const metadata: Metadata = {
  title: "Social Character Counter & Word Counter | RetroToolsHQ",
  description:
    "Free instant social character counter with platform presets for X, Instagram, TikTok, and YouTube. Counts characters with and without spaces, words, sentences, reading time. No signup required.",
  keywords: [
    "character counter",
    "word counter",
  ...
  openGraph: {
    ...
    title: "Social Character Counter & Word Counter | RetroToolsHQ",
    description:
      "Free instant social character counter with platform presets for X, Instagram, TikTok, and YouTube. No signup required.",
  ...
  twitter: {
    ...
    description:
      "Instantly count characters for X, Instagram, TikTok, and YouTube. Free, no signup.",
  },
  other: {
    "theme-color": "#F8F7F4",
  },
...
const webApplicationSchema = {
  ...
  url: "https://retrotoolshq.com",
  description:
    "Free browser-based social character counter with platform presets for X (Twitter), Instagram, TikTok, and YouTube. Counts characters, words, sentences, paragraphs, and estimates reading and speaking time.",
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "The Normalize Spaces button collapses multiple consecutive spaces and tabs into a single space, and removes leading/trailing whitespace from each line.",
      },
    },
    {
      "@type": "Question",
